...
public class SandboxCleanup
{
    ...
    private async Task CleanupCheckoutsAsync()
    {
        ...
        try
        {
            var checkouts = new List<Polar.NET.Models.Checkouts.Checkout>();
    ...
    private async Task CleanupLicenseKeysAsync()
    {
        ...
        try
        {
            var licenseKeys = new List<Polar.NET.Models.LicenseKeys.LicenseKey>();
    ...
    private async Task CleanupDiscountsAsync()
    {
        ...
        try
        {
            var discounts = new List<Polar.NET.Models.Discounts.Discount>();
    ...
    private async Task CleanupWebhooksAsync()
    {
        ...
        try
        {
            var page = 1;
            var hasMore = true;
            var webhooks = new List<Polar.NET.Models.Webhooks.WebhookEndpoint>();
    ...
    private async Task CleanupFilesAsync()
    {
        ...
        try
        {
            var files = new List<Polar.NET.Models.Files.File>();
